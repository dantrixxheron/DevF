...
function agregarLibro(titulo, autor, genero, disponible) {
    ...
    setTimeout(() => {
        ...
        console.log(`El libro ${titulo} se ha agregado con éxito.`);
    }, 1000);
}
...
function actualizarDisponibilidad(titulo, nuevoEstado) {
    ...
    setTimeout(() => {
        ...
        if(libro){
            ...
            console.log(`La disponibilidad de ${titulo} se ha actualizado.`);
        }else{
            console.log(`El libro ${titulo} no encontrado.`);
